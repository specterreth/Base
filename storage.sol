...
contract EmployeeStorage {
    ...
    constructor(uint16 _shares, string memory _name, uint32 _salary, uint _idNumber) {
        shares = _shares; // Initialize shares 1000
        name = _name; // Initialize name Pat
        salary = _salary; // Initialize salary 50000
        idNumber = _idNumber; // Initialize idNumber 112358132134
    }
